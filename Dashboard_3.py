...
def cargar_datos():
    ...
    # Crear columnas correctas basadas en el CSV real
...
def dashboard3(df):
    ...
    # =====================================================
    # 1) MAPA DE RIESGO
    # riesgo = descargas_totales / tomas_totales
    # =====================================================
    ...
    df_riesgo["riesgo"] = (
        df_riesgo["descargas_totales"] /
        df_riesgo["tomas_totales"]
    ...
    # =====================================================
    # 5) Pie — Proporción nacional de tipos de descarga
    # =====================================================
    ...
    fig_pie = px.pie(
        ...
        names="Tipo",
        values="Valor",
        title="Composición de descargas sin tratamiento"
    )
    ...
    df_box_long = df_f[indicadores_sel].melt(
        var_name="Indicador",
        value_name="Valor"
    )
    ...
    fig_box = px.box(
        ...
        x="Indicador",
        y="Valor",
        title="Distribución por indicador"
    )
    st.plotly_chart(fig_box, use_container_width=True)

    # =====================================================
    # 7) 100% Stacked — Estructura de descargas
    # =====================================================
    ...
    fig_stack = px.bar(
        ...
        barmode="relative",
        title="Distribución relativa por tipo de descarga"
    )
    st.plotly_chart(fig_stack, use_container_width=True)

    # =====================================================
    # 8) Bubble chart — Prioridades
    # =====================================================
    ...
    fig_bubble = px.scatter(
        ...
        color="Estado",
        title="Impacto y urgencia por estado"
    )
    st.plotly_chart(fig_bubble, use_container_width=True)

    # =====================================================
    # 9) Tabla de recomendaciones
    # =====================================================
